...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/less-loader/index.js!./popbox.less", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/less-loader/index.js!./popbox.less");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "@charset \"utf-8\";\n.spa-popbox {\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  background: rgba(0, 0, 0, 0.5);\n  z-index: 999;\n  display: -webkit-flex;\n  display: -moz-flex;\n  display: flex;\n  -webkit-justify-content: center;\n  -moz-justify-content: center;\n  justify-content: center;\n  -webkit-align-items: center;\n  -moz-align-items: center;\n  align-items: center;\n}\n.spa-popbox .spa-popbox-container {\n  display: -webkit-flex;\n  display: -moz-flex;\n  display: flex;\n  -webkit-flex-flow: column nowrap;\n  -moz-flex-flow: column nowrap;\n  flex-flow: column nowrap;\n  width: 80%;\n  height: 30%;\n  background-color: #e9e9e9;\n  -webkit-box-shadow: 0px 0px 6px 1px #7A7C7A;\n  -moz-box-shadow: 0px 0px 6px 1px #7A7C7A;\n  box-shadow: 0px 0px 6px 1px #7A7C7A;\n  -webkit-border-radius: 0.5em;\n  -moz-border-radius: 0.5em;\n  border-radius: 0.5em;\n  overflow: hidden;\n}\n.spa-popbox .spa-popbox-container > div {\n  -webkit-flex: 1;\n  -moz-flex: 1;\n  flex: 1;\n}\n.spa-popbox .spa-popbox-container .spa-popbox-content .msg {\n  text-indent: -2px;\n  padding: 18px 15px 10px;\n  text-align: center;\n  line-height: 20px;\n}\n.spa-popbox .spa-popbox-container .spa-popbox-operate {\n  position: relative;\n  max-height: 45px;\n  display: -webkit-flex;\n  display: -moz-flex;\n  display: flex;\n  -webkit-flex-flow: row nowrap;\n  -moz-flex-flow: row nowrap;\n  flex-flow: row nowrap;\n  border-top: 1px solid #ccc;\n}\n.spa-popbox .spa-popbox-container .spa-popbox-operate .spa-popbox-button {\n  -webkit-border-radius: 0.2em;\n  -moz-border-radius: 0.2em;\n  border-radius: 0.2em;\n  -webkit-flex: 1;\n  -moz-flex: 1;\n  flex: 1;\n  display: -webkit-flex;\n  display: -moz-flex;\n  display: flex;\n  -webkit-justify-content: center;\n  -moz-justify-content: center;\n  justify-content: center;\n  -webkit-align-items: center;\n  -moz-align-items: center;\n  align-items: center;\n  -webkit-transition: background-color 0.2s;\n  -moz-transition: background-color 0.2s;\n  transition: background-color 0.2s;\n  color: #2767a5;\n  background-color: #e9e9e9;\n}\n.spa-popbox .spa-popbox-container .spa-popbox-operate .spa-popbox-button:active {\n  background-color: #ccc;\n}\n", ""]);
...
/***/ function(module, exports) {
	...
	with (obj) {
	__p += '<div class="spa-popbox ' +
	((__t = (poptype)) == null ? '' : __t) +
	'">\n    <div class="spa-popbox-container">\n        <div class="spa-popbox-content">\n            <div class="msg">\n                ' +
	((__t = (msg)) == null ? '' : __t) +
	'\n            </div>\n        </div>\n        <div class="spa-popbox-operate">\n            ';
	if(poptype == 'alert') {;
	__p += '\n            ';
	}else if(poptype == 'confirm'){;
	__p += '\n            <span class="spa-popbox-button cancel">取消</span>\n            ';
	};
	__p += '\n            <span class="spa-popbox-button submit">确定</span>\n        </div>\n    </div>\n</div>';
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	!(function (a, b) {
	     true ? !(__WEBPACK_AMD_DEFINE_FACTORY__ = (b), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.call(exports, __webpack_require__, exports, module)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : a.touch = b();
	})(undefined, function () {
	    function a() {
	    ...
	    var c = {
	        proxyid: 0, proxies: [], trigger: function trigger(a, b, c) {
	            c = c || {};
	            var d,
	        ...
	        }, delegate: function delegate(a, c, d, e) {
	            var f = function f(c) {
	                var f, g;
	                c.originEvent = c;
	        ...
	        }, undelegate: function undelegate(a, b, c, d) {
	            if (d) {
	                var e = d.proxy[b];
	        ...
	        y = null,
	        z = {
	        getAngleDiff: function getAngleDiff(a) {
	        ...
	        }, rotateSingleFinger: function rotateSingleFinger(a) {
	            var d = a.target;
